...
const GITMOJIS_URL = 'https://xquare-emoji-server.herokuapp.com/';
exports.GITMOJIS_URL = GITMOJIS_URL;

const getEmojis = (skipCache = false) => {
  if (_emojisCache.default.isAvailable() && !skipCache) return _emojisCache.default.getEmojis();
  const spinner = (0, _ora.default)('Fetching the emoji list').start();
  return (0, _nodeFetch.default)(GITMOJIS_URL, (0, _buildFetchOptions.default)()).then(response => response.json()).then(data => {
